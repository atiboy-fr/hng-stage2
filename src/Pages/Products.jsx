  ...
  return (
    <div className='bg-[#F4F4F4]'>
        ...
        <div className='flex justify-between items-center w-11/12 m-auto mb-7'>
         ...
         <div className='hidden sm:flex justify-between items-center w-screen gap-5 lg:w-screen'>
        ...
        <div className='w-11/12 m-auto mb-6'>
          ...
          <div className='flex justify-between flex-wrap gap-2 sm:justify-stretch sm:w-screen md:gap-2 lg:justify-center lg:gap-10 sm:gap-1 lg:w-[100%]'>
            ...
            <div className='bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
              ...
              <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$650</h2>
              ...
              <div className='sm:flex justify-between items-center'>
                <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('650', 'Automobile 1', 'Suzuki special edition, black limited', 'images/bike1.png', 1)}>
                  <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
                  <p className='text-white text-sm font-semibold'>ADD TO CART</p>
                </button>
                <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
              </div>
            </div>

            <div className='bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
              <img src={'images/bike2.png'} alt="bike 1" className='w-36 pb-3'/>
              <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$380</h2>
            ...
            <div className='sm:flex justify-between items-center'>
              <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('380', 'Automobile 2', 'Twin turbo exhuast with V6 engines', 'images/bike2.png', 2)}>
                <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
                <p className='text-white text-sm font-semibold'>ADD TO CART</p>
              </button>
              <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
            ...
            <div className='bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
              ...
              <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$840</h2>
              <h3 className='text-black font-bold text-lg pb-3'>Automobile 3</h3>
              <p className='text-[#000000] text-sm font-light pb-3'>Retro bikers finish with rear view</p>
            ...
            <div className='sm:flex justify-between items-center'>
              <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('840', 'Automobile 3', 'Retro bikers finish with rear view mirrors', 'images/bike3.png', 3)}>
                <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
                <p className='text-white text-sm font-semibold'>ADD TO CART</p>
              </button>
              <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
            ...
            <div className='bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
              ...
              <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$935</h2>
            ...
            <div className='sm:flex justify-between items-center'>
              <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('935', 'Automobile 4', 'Ducati special edition, yellow limited', 'images/bike4.png', 4)}>
                <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
                <p className='text-white text-sm font-semibold'>ADD TO CART</p>
              </button>
              <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
            ...
            <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$500</h2>
          ...
          <div className='sm:flex justify-between items-center'>
            <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('500', 'Automobile 5', 'Single exhuast motor, low version', 'images/bike5.png', 5)}>
              <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
              <p className='text-white text-sm font-semibold'>ADD TO CART</p>
            </button>
            <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
          ...
          <div className='hidden sm:block bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
            ...
            <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$260</h2>
          ...
          <div className='sm:flex justify-between items-center'>
            <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('260', 'Automobile 6', 'Retro classique, Joanne special', 'images/bike6.png', 6)}>
              <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
              <p className='text-white text-sm font-semibold'>ADD TO CART</p>
            </button>
            <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
          ...
          <div className='hidden sm:block bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
            ...
            <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$999</h2>
          ...
          <div className='sm:flex justify-between items-center'>
            <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('999', 'Automobile 7', 'Special edition, Della Rossa', 'images/bike7.png', 7)}>
              <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
              <p className='text-white text-sm font-semibold'>ADD TO CART</p>
            </button>
            <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
          ...
          <div className='hidden sm:block bg-white w-40 drop-shadow-lg p-3 rounded-md lg:w-64 md:w-44'>
            ...
            <h2 className='text-[#CE1515] font-bold text-2xl pb-3 sm:text-black'>$105</h2>
          ...
          <div className='sm:flex justify-between items-center'>
            <button className='flex justify-around items-center border border-solid border-[#CE1515] bg-[#CE1515] p-1 sm:p-2 gap-3 rounded-lg hover:bg-[#ce1515d8] active:bg-[red]' onClick={() => handleProducts('105', 'Automobile 8', 'Veronica Elangate, special series', 'images/bike8.png', 8)}>
              <FontAwesomeIcon icon={faCartPlus} style={{color: "#ffffff",}} />
              <p className='text-white text-sm font-semibold'>ADD TO CART</p>
            </button>
            <FontAwesomeIcon icon={faHeart} size='lg' style={{color: "#000000",}} className='hidden lg:block'/>
